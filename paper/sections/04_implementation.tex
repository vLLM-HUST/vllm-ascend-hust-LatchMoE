...
strict validation rejects duplicate or missing coverage. A preflight-qualified
overflow decision may select the explicit full-layer mode; NPU, ACL, memory,
address, semantic, and lifecycle failures are not swallowed by that path.
