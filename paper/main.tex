...
qualification on Qwen3-30B-A3B records exact output agreement, stable addresses,
transfer ordering, bounded residency, and service release across three
independent starts.  In three matched pairs, capacity-bounded multi-wave
