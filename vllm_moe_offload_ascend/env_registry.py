...
ENVIRONMENT_VARIABLES: dict[str, EnvLoader] = {
    ...
    "VLLM_ASCEND_MOE_GRAPH_REPLAY_PROFILE_SAMPLE_RATE": _integer(
        "VLLM_ASCEND_MOE_GRAPH_REPLAY_PROFILE_SAMPLE_RATE", "1024"
    ),
    "VLLM_ASCEND_MOE_PROFILE_ROUTING_TRACE": _boolean(
    ...
    "VLLM_ASCEND_MOE_ROUTER_PARITY_MAX_TOKENS": _integer(
        "VLLM_ASCEND_MOE_ROUTER_PARITY_MAX_TOKENS", "64"
    ),
    "VLLM_ASCEND_MOE_ROUTER_PARITY_PATH": _string(
